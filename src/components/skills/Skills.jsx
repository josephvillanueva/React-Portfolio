...
const skills = [
  ...
  { name: "Ruby on Rails", category: "Backend & Cloud", Icon: SiRubyonrails, color: "#d30001" },
  { name: "PostgreSQL", category: "Backend & Cloud", Icon: SiPostgresql, color: "#4169e1" },
  ...
  { name: "Jira", category: "Tools", Icon: SiJira, color: "#2684ff" },
